...
public class UserrolesController implements Serializable {
    ...
    @EJB
    private forgetSession.UserrolesFacade ejbFacade;
    ...
    public Userroles getSelected() {
        if (current == null) {
            ...
            current.setUserrolesPK(new forget.UserrolesPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Userroles getUserroles(forget.UserrolesPK id) {
    ...
    public static class UserrolesControllerConverter implements Converter {
        ...
        forget.UserrolesPK getKey(String value) {
            forget.UserrolesPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new forget.UserrolesPK();
        ...
        String getStringKey(forget.UserrolesPK value) {
